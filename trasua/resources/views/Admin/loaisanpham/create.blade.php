                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Thêm loại sản phẩm</h2>
                            </div>
                        </div>
                    </div>
                    <div class="nk-block">
                        <form action="{{ route('loaisanpham.store') }}" method="post" enctype="multipart/form-data" id="form-create">
                            @csrf
                            <div class="row g-gs">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="ten_loai"
                                                                ...
                                                                <div class="form-control-wrap"><input type="text"
                                                                        ...
                                                                        value="{{ old('ten_loai') }}" maxlength="100" minlength="1"
