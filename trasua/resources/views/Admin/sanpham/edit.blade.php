        ...
        <div class="container">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <form action="{{ route('sanpham.update', ['slug' => $san_pham->slug]) }}" method="post" enctype="multipart/form-data"
                            id="form-edit">
                            @csrf
                            @method('put')
                            <div class="row g-gs">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="kich_co"
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <div class="form-control-wrap">
                                                                        @php
                                                                            $data = json_decode($san_pham->kich_co);
                                                                        @endphp
                                                                        @foreach ($kich_co as $key => $kc)
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    value="{{ $kc->id }}"
                                                                                    name="kich_co[]"
                                                                                    @if (is_array($data) && in_array($kc->id, $data)) checked @endif>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="so_luong"
                                                                ...
                                                                <div class="form-control-wrap"><input type="number"
                                                                        ...
                                                                        name="so_luong" value="{{ $san_pham->so_luong }}"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="gia_goc"
                                                                ...
                                                                <div class="form-control-wrap"><input type="text"
                                                                        ...
                                                                        name="gia_goc" value="{{ $san_pham->gia_goc }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="media media-huge border">
                                                                    <img id="img" class="w-100 h-100"
                                                                        src="{{ asset('storage/images/sanpham/' . $san_pham->anh_san_pham) }}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="pt-3">
                                                                    <input class="upload-image" data-target="img"
                                                                        id="change_img" name="change_img" type="file"
                                                                        max="1" value="{{ $san_pham->anh_san_pham }}" hidden>
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="js-select" name="trang_thai"
                                                                ...
                                                                @foreach ($trang_thai as $tt)
                                                                    <option value="{{ $tt->id }}"
                                                                        {{ $san_pham->id_trang_thai == $tt->id ? 'selected' : '' }}>
                                                                        {{ $tt->ten_trang_thai }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        @if ($errors)
                                                                ...
                                                                <select class="js-select" name="id_loai_san_pham"
                                                                    ...
                                                                    @foreach ($loai_san_pham as $loai)
                                                                        <option value="{{ $loai->id }}"
                                                                            {{ old('id_loai_san_pham') == $loai->id ? 'selected' : '' }}>
